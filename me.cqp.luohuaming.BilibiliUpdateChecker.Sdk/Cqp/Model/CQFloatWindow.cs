...
namespace me.cqp.luohuaming.BilibiliUpdateChecker.Sdk.Cqp.Model
{
    ...
    public class CQFloatWindow : IToSendString, IEquatable<CQFloatWindow>
    {
        ...
        {
            return other != null && this.Value.Equals(other.Value) && this.Unit.Equals(other.Unit) && this.TextColor == other.TextColor;
        }
        /// <summary>
        /// 指示当前对象是否等于同一类型的另一个对象
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            builder.AppendLine(string.Format("数据: {0}", this.Value ?? string.Empty));
