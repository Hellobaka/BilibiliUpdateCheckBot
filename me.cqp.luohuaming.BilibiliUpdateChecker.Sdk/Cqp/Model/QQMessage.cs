...
namespace me.cqp.luohuaming.BilibiliUpdateChecker.Sdk.Cqp.Model
{
    /// <summary>
    /// 描述 QQ消息 的类
    /// </summary>
    public class QQMessage : BasisStreamModel, IEquatable<QQMessage>
    {
        ...
        public bool IsImageMessage
        {
            get
            {
                return this.CQCodes.Count != 0 && this.CQCodes.All(CQCode.EqualIsImageCQCode);
            }
        }
        /// <summary>
        ...
        public bool IsRecordMessage
        {
            get
            {
                return this.CQCodes.Count != 0 && this.CQCodes.All(CQCode.EqualIsRecordCQCode);
            }
        }
        #endregion
        ...
        public string ReceiveRecord(CQAudioFormat format)
        {
            ...
            return this.IsRecordMessage ? this.CQApi.ReceiveRecord(this.CQCodes[0].Items["file"], format) : null;
        }
        /// <summary>
        ...
        {
            return other != null && this.Id == other.Id && this.Text.Equals(other.Text);
        }
        /// <summary>
        /// 指示当前对象是否等于同一类型的另一个对象
        /// </summary>
