using me.cqp.luohuaming.BilibiliUpdateChecker.Sdk.Cqp.Core;
using me.cqp.luohuaming.BilibiliUpdateChecker.Sdk.Cqp.Enum;
using me.cqp.luohuaming.BilibiliUpdateChecker.Sdk.Cqp.Expand;
...
namespace me.cqp.luohuaming.BilibiliUpdateChecker.Sdk.Cqp
{
    /// <summary>
    /// 表示 酷Q接口 的封装类
    /// </summary>
    public class CQApi
    {
        ...
        /// 获取接口默认编码
        /// </summary>
        public static Encoding DefaultEncoding { get; private set; } = null;
        /// <summary>
        ...
        /// 获取当前实例的应用信息
        /// </summary>
        public AppInfo AppInfo { get; } = null;
        /// <summary>
        ...
        public bool SendPraise(long qqId, int count = 1)
        {
            return qqId < QQ.MinValue
                ...
                : CQP.CQ_sendLikeV2(this.AppInfo.AuthCode, qqId, count) == 0;
        }
        /// <summary>
        /// 撤回消息
        /// </summary>
        ...
        {
            return msgId < 0 ? throw new ArgumentOutOfRangeException("msgId") : CQP.CQ_deleteMsg(this.AppInfo.AuthCode, msgId) == 0;
        }
        /// <summary>
        /// 撤回消息
        /// </summary>
        ...
        {
            return message == null ? throw new ArgumentNullException("message") : this.RemoveMessage(message.Id);
        }
        /// <summary>
        ...
        public string ReceiveRecord(CQCode recordCode, CQAudioFormat format)
        {
            return recordCode == null
                ...
                : recordCode.Function != CQFunction.Record
                ? throw new ArgumentException("传入的CQ码不是 \"Record\" 类型", "recordCode")
                : this.ReceiveRecord(recordCode.Items["file"], format);
        }
        /// <summary>
        ...
        public string ReceiveImage(CQCode imageCode)
        {
            return imageCode == null
                ...
                : imageCode.Function != CQFunction.Image
                ? throw new ArgumentException("传入的CQ码不是 \"Image\" 类型", "imageCode")
                : this.ReceiveImage(imageCode.Items["file"]);
        }
        #endregion
        ...
        {
            string data = CQP.CQ_getFriendList(this.AppInfo.AuthCode, false).ToString(DefaultEncoding);
            if (string.IsNullOrEmpty(data))
            {
#if DEBUG
                throw new InvalidDataException("获取的数据流格式无效");
        ...
        public bool SetGroupMemberBanSpeak(long groupId, long qqId, TimeSpan time)
        {
            return groupId < Group.MinValue
                ...
                : qqId < QQ.MinValue
                ? throw new ArgumentOutOfRangeException("qqId")
                : time.TotalSeconds <= 0 || time.TotalSeconds > 2592000
                ? throw new ArgumentOutOfRangeException("time")
                : CQP.CQ_setGroupBan(this.AppInfo.AuthCode, groupId, qqId, (long)time.TotalSeconds) == 0;
        }
        /// <summary>
        /// 解除群成员禁言
        /// </summary>
        ...
        public bool RemoveGroupMemberBanSpeak(long groupId, long qqId)
        {
            return groupId < Group.MinValue
                ...
                : qqId < QQ.MinValue
                ? throw new ArgumentOutOfRangeException("qqId")
                : CQP.CQ_setGroupBan(this.AppInfo.AuthCode, groupId, qqId, 0) == 0;
        }
        /// <summary>
        /// 设置群全体禁言
        /// </summary>
        ...
        public bool SetGroupBanSpeak(long groupId)
        {
            return groupId < Group.MinValue
                ? throw new ArgumentOutOfRangeException("groupId")
                : CQP.CQ_setGroupWholeBan(this.AppInfo.AuthCode, groupId, true) == 0;
        }
        /// <summary>
        /// 解除群全体禁言
        /// </summary>
        ...
        public bool RemoveGroupBanSpeak(long groupId)
        {
            return groupId < Group.MinValue
                ? throw new ArgumentOutOfRangeException("groupId")
                : CQP.CQ_setGroupWholeBan(this.AppInfo.AuthCode, groupId, false) == 0;
        }
        /// <summary>
        /// 设置群成员名片
        /// </summary>
        ...
        public bool SetGroupManage(long groupId, long qqId)
        {
            return groupId < Group.MinValue
                ...
                : qqId < QQ.MinValue
                ? throw new ArgumentOutOfRangeException("qqId")
                : CQP.CQ_setGroupAdmin(this.AppInfo.AuthCode, groupId, qqId, true) == 0;
        }
        /// <summary>
        /// 解除群管理员
        /// </summary>
        ...
        public bool RemoveGroupManage(long groupId, long qqId)
        {
            return groupId < Group.MinValue
                ...
                : qqId < QQ.MinValue
                ? throw new ArgumentOutOfRangeException("qqId")
                : CQP.CQ_setGroupAdmin(this.AppInfo.AuthCode, groupId, qqId, false) == 0;
        }
        /// <summary>
        /// 开启群匿名
        /// </summary>
        ...
        public bool OpenGroupAnonymous(long groupId)
        {
            return groupId < Group.MinValue
                ? throw new ArgumentOutOfRangeException("groupId")
                : CQP.CQ_setGroupAnonymous(this.AppInfo.AuthCode, groupId, true) == 0;
        }
        /// <summary>
        /// 关闭群匿名
        /// </summary>
        ...
        public bool StopGroupAnonymous(long groupId)
        {
            return groupId < Group.MinValue
                ? throw new ArgumentOutOfRangeException("groupId")
                : CQP.CQ_setGroupAnonymous(this.AppInfo.AuthCode, groupId, false) == 0;
        }
        /// <summary>
        /// 退出群. 慎用, 此接口需要严格授权
        /// </summary>
        ...
        public bool ExitGroup(long groupId)
        {
            return groupId < Group.MinValue
                ? throw new ArgumentOutOfRangeException("groupId")
                : CQP.CQ_setGroupLeave(this.AppInfo.AuthCode, groupId, false) == 0;
        }
        /// <summary>
        /// 解散群. 慎用, 此接口需要严格授权
        /// </summary>
        ...
        public bool DissolutionGroup(long groupId)
        {
            return groupId < Group.MinValue
                ? throw new ArgumentOutOfRangeException("groupId")
                : CQP.CQ_setGroupLeave(this.AppInfo.AuthCode, groupId, true) == 0;
        }
        /// <summary>
        /// 退出讨论组.
        /// </summary>
        ...
        {
            return discussId < Discuss.MinValue
                ? throw new ArgumentOutOfRangeException("discussId")
                : CQP.CQ_setDiscussLeave(this.AppInfo.AuthCode, discussId) == 0;
        }
        /// <summary>
        /// 移除群成员
        /// </summary>
        ...
        public bool RemoveGroupMember(long groupId, long qqId, bool notRequest = false)
        {
            return groupId < Group.MinValue
                ...
                : qqId < QQ.MinValue
                ? throw new ArgumentOutOfRangeException("qqId")
                : CQP.CQ_setGroupKick(this.AppInfo.AuthCode, groupId, qqId, notRequest) == 0;
        }
        #endregion
