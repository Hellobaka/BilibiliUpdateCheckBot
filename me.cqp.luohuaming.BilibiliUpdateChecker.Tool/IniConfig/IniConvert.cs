...
using me.cqp.luohuaming.BilibiliUpdateChecker.Tool.IniConfig.Exception;
...
namespace me.cqp.luohuaming.BilibiliUpdateChecker.Tool.IniConfig
{
    ...
    public static class IniConvert
    {
        ...
        public static IniSection SerializeObject(object obj)
        {
            ...
            inisect = sectionAttribute != null ? new IniSection(sectionAttribute.SectionName) : new IniSection(objType.Name);
        ...
        public static object DeserializeObject(IniSection obj, Type type)
        {
            ...
            List<PropertyInfo> properties = new(type.GetRuntimeProperties());
        ...
        {
            return obj == null ? throw new ArgumentNullException("obj") : (T)DeserializeObject(obj, typeof(T));
        }
