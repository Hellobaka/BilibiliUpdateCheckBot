...
namespace me.cqp.luohuaming.BilibiliUpdateChecker.Tool.IniConfig.Linq
{
    ...
    public class IniValue : IEquatable<IniValue>, IComparable, IComparable<IniValue>, IConvertible
    {
        ...
        {
            return other == null ? throw new ArgumentNullException("other") : this.Value.CompareTo(other.Value);
        }
        ...
        {
            return other != null && string.Compare(this.Value, other.Value) == 0;
        }
        ...
        {
            return this.Value == null ? TypeCode.Empty : Value.GetTypeCode();
        }

        /// <summary>
        /// 使用指定的区域性特定格式设置信息，将逻辑值的指定字符串表示形式转换为其等效的布尔值。
        /// </summary>
        /// <returns>如果 true 等于该实例，则为 <see cref="bool.TrueString"/>；如果 false 等于该实例 或 <see cref="bool.FalseString"/>，则为 null</returns>
