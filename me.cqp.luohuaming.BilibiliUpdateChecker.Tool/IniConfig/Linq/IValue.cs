using me.cqp.luohuaming.BilibiliUpdateChecker.Tool.IniConfig.Utilities;
using System;
using System.Collections.Generic;
using System.Globalization;
using System.Numerics;

namespace me.cqp.luohuaming.BilibiliUpdateChecker.Tool.IniConfig.Linq
{
    /// <summary>
    /// 描述配置项 (Ini) 值的类
    /// </summary>
    public sealed class IValue : IEquatable<IValue>, IComparable<IValue>, IComparable, ICloneable, IConvertible
    {
        ...
        public object Value
        {
            ...
            {
                this._value = value;
                this.Type = IValue.GetValueType(value);
            }
        }
        #endregion
        ...
        {
            return v1 == v2 || (v1 != null && v2 != null && v1.Type == v2.Type && IValue.Compare(v1, v2) == 0);
        }
        /// <summary>
        ...
        public object Clone()
        {
            return new IValue(this._value, this.Type);
        }
        /// <summary>
        ...
        {
            return obj == null ? 1 : obj is IValue value ? IValue.Compare(this, value) : Comparer<object>.Default.Compare(this._value, obj);
        }
        /// <summary>
        /// 将当前实例与同一类型的另一个对象进行比较，并返回一个整数，该整数指示当前实例在排序顺序中的位置是位于另一个对象之前、之后还是与其位置相同。
        /// </summary>
        ...
        public int CompareTo(IValue other)
        {
            return other == null
                ? 1
                : this.Type == IValueType.String && this.Type != other.Type ? IValue.Compare(other, this) : IValue.Compare(this, other);
        }
        /// <summary>
        ...
        {
            return object.Equals(this._value, null)
                ? TypeCode.Empty
                : this._value is IConvertible ? ((IConvertible)this._value).GetTypeCode() : TypeCode.Object;
        }
        /// <summary>
        ...
        private static IValueType GetValueType(object value)
        {
            ...
            if (value is sbyte or byte or char or short or ushort or int or uint or long or ulong)
            {
            ...
            return value is byte[]? IValueType.Bytes
                : value is string
                ? IValueType.String
                : value is Guid
                ? IValueType.Guid
                : value is Uri ? IValueType.Uri : throw new ArgumentException(string.Format("无法确定类型为 Ini 可描述的类型 {0}", value.GetType().Name));
        }
        /// <summary>
        /// 获取是否可以转换到目标类型
        /// </summary>
        ...
        private static int Compare(IValue valueA, IValue valueB)
        {
            ...
            switch (valueA.Type)
            {
                ...
                case IValueType.Integer:
                    {
                        if (valueA._value is BigInteger numA)
                        {
                            return IValue.CompareBigInteger(numA, valueB._value);
                        }
                        if (valueB._value is BigInteger numB)
                        {
                ...
                case IValueType.DateTime:
                    {
                        if (valueA._value is DateTime dtA)
                        {
                            DateTime dtB = valueB._value is DateTimeOffset
                                ? ((DateTimeOffset)valueB._value).DateTime
                                : Convert.ToDateTime(valueB._value, CultureInfo.InvariantCulture);
                            return dtA.CompareTo(dtB);
                        }
                        DateTimeOffset offsetA = (DateTimeOffset)valueA._value;
                        DateTimeOffset offsetB = valueB._value is DateTimeOffset
                            ? (DateTimeOffset)valueB._value
                            : new DateTimeOffset(Convert.ToDateTime(valueB._value, CultureInfo.InvariantCulture));
                        return offsetA.CompareTo(offsetB);
                    }
                case IValueType.TimeSpan:
                    {
                        if (valueB._value is not TimeSpan)
                        {
                ...
                case IValueType.Bytes:
                    {
                        ...
                        return valueB._value is not byte[] bytesB ? throw new ArgumentException("对象必须是 byte[] 类型") : MiscellaneousUtils.ByteArrayCompare(bytesA, bytesB);
                    }
                case IValueType.Uri:
                    {
                        ...
                        return uriB == null
                            ...
                            : Comparer<string>.Default.Compare(uriA.ToString(), uriB.ToString());
                    }
                case IValueType.Guid:
                    {
                        if (valueB._value is not Guid)
                        {
        ...
        private static int CompareFloat(object v1, object v2)
        {
            ...
            return MathUtils.ApproxEquals(d, num) ? 0 : d.CompareTo(num);
        }
        #endregion
        ...
        public static implicit operator bool(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertBooleanTypes, false)
                ? throw new ArgumentException(string.Format("无法将 {0} 转换为 Boolean", ivalue.GetType().Name))
                : ivalue is BigInteger value2 ? Convert.ToBoolean((int)ivalue) : Convert.ToBoolean(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        {
            object ivalue = value._value;
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertNumberTypes, false)
                ? throw new ArgumentException(string.Format("无法将 {0} 转换为 SByte", ivalue.GetType().Name))
                : ivalue is BigInteger value2 ? (sbyte)value2 : Convert.ToSByte(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        public static implicit operator byte(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertNumberTypes, false)
                ...
                : ivalue is BigInteger value2 ? (byte)value2 : Convert.ToByte(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        {
            object ivalue = value._value;
            return ivalue != null || !IValue.IsConvert(value.Type, IValue.ConvertCharTypes, false)
                ? throw new ArgumentException(string.Format("无法将 {0} 转换为 Char", value._value.GetType().Name))
                : ivalue is BigInteger value2 ? (char)(ushort)value2 : Convert.ToChar(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        public static implicit operator short(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertNumberTypes, false)
                ...
                : ivalue is BigInteger value2 ? (short)value2 : Convert.ToInt16(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        public static implicit operator ushort(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertNumberTypes, false)
                ...
                : ivalue is BigInteger value2 ? (ushort)value2 : Convert.ToUInt16(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        public static implicit operator int(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertNumberTypes, false)
                ...
                : ivalue is BigInteger value2 ? (int)value2 : Convert.ToInt32(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        public static implicit operator uint(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertNumberTypes, false)
                ...
                : ivalue is BigInteger value2 ? (uint)value2 : Convert.ToUInt32(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        public static implicit operator long(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertNumberTypes, false)
                ...
                : ivalue is BigInteger value2 ? (long)value2 : Convert.ToInt64(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        public static implicit operator ulong(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertNumberTypes, false)
                ...
                : ivalue is BigInteger value2 ? (ulong)value2 : Convert.ToUInt64(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        public static implicit operator float(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertNumberTypes, false)
                ...
                : ivalue is BigInteger value2 ? (float)value2 : Convert.ToSingle(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        public static implicit operator double(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertNumberTypes, false)
                ...
                : ivalue is BigInteger value2 ? (double)value2 : Convert.ToDouble(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        public static implicit operator decimal(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertNumberTypes, false)
                ...
                : ivalue is BigInteger value2 ? (decimal)value2 : Convert.ToDecimal(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        {
            object ivalue = value._value;
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertDateTimeTypes, false)
                ? throw new ArgumentException(string.Format("无法将 {0} 转换为 DateTime", value._value.GetType().Name))
                : ivalue is DateTimeOffset ? ((DateTimeOffset)ivalue).DateTime : Convert.ToDateTime(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        public static implicit operator DateTimeOffset(IValue value)
        {
            ...
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertDateTimeTypes, false)
                ...
                : ivalue is DateTimeOffset
                ? (DateTimeOffset)ivalue
                : ivalue is string input
                ? DateTimeOffset.Parse(input, CultureInfo.InvariantCulture)
                : new DateTimeOffset(Convert.ToDateTime(ivalue, CultureInfo.InvariantCulture));
        }
        /// <summary>
        ...
        {
            object ivalue = value._value;
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertTimeSpanTypes, false)
                ? throw new ArgumentException(string.Format("无法将 {0} 转换为 TimeSpan", value._value.GetType().Name))
                : value._value is TimeSpan
                ? (TimeSpan)value._value
                : ConvertUtils.StringToTimeSpan(Convert.ToString(ivalue, CultureInfo.InvariantCulture));
        }
        /// <summary>
        ...
        public static implicit operator byte[](IValue value)
        {
            ...
            object ivalue = value._value;
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertBytesTypes, false)
                ? throw new ArgumentException(string.Format("无法将 {0} 转换为 byte[]", value._value.GetType().Name))
                : ivalue is string
                ? Convert.FromBase64String(Convert.ToString(ivalue, CultureInfo.InvariantCulture))
                : ivalue is BigInteger
                ? ((BigInteger)ivalue).ToByteArray()
                : ivalue is byte[] result ? result : throw new ArgumentException(string.Format("无法将 {0} 转换为 byte[]", value._value.GetType().Name));
        }
        /// <summary>
        ...
        public static implicit operator string(IValue value)
        {
            ...
            object ivalue = value._value;
            return !IValue.IsConvert(value.Type, IValue.ConvertStringTypes, true)
                ? throw new ArgumentException(string.Format("无法将 {0} 转换为 String", value._value.GetType().Name))
                : ivalue == null
                ? null
                : ivalue is byte[] inArray
                ? Convert.ToBase64String(inArray)
                : ivalue is BigInteger
                ? ((BigInteger)ivalue).ToString(CultureInfo.InvariantCulture)
                : Convert.ToString(ivalue, CultureInfo.InvariantCulture);
        }
        /// <summary>
        ...
        {
            object ivalue = value._value;
            return ivalue == null || !IValue.IsConvert(value.Type, IValue.ConvertGuidTypes, false)
                ? throw new ArgumentException(string.Format("无法将 {0} 转换为 Guid", value._value.GetType().Name))
                : ivalue is byte[] inArray
                ? new Guid(inArray)
                : ivalue is Guid ? (Guid)ivalue : new Guid(Convert.ToString(ivalue, CultureInfo.InvariantCulture));
        }
        /// <summary>
        ...
        public static implicit operator Uri(IValue value)
        {
            ...
            object ivalue = value._value;
            if (!IValue.IsConvert(value.Type, IValue.ConvertUirTypes, true))
            {
            ...
            return result ?? new Uri(Convert.ToString(ivalue, CultureInfo.InvariantCulture));
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="bool"/>
        /// </summary>
        ...
        public static implicit operator bool?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new bool?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="sbyte"/>
        /// </summary>
        ...
        public static implicit operator sbyte?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new sbyte?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="byte"/>
        /// </summary>
        ...
        public static implicit operator byte?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new byte?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="char"/>
        /// </summary>
        ...
        public static implicit operator char?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new char?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="short"/>
        /// </summary>
        ...
        public static implicit operator short?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new short?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="ushort"/>
        /// </summary>
        ...
        public static implicit operator ushort?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new ushort?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="int"/>
        /// </summary>
        ...
        public static implicit operator int?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new int?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="uint"/>
        /// </summary>
        ...
        public static implicit operator uint?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new uint?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="long"/>
        /// </summary>
        ...
        public static implicit operator long?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new long?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="ulong"/>
        /// </summary>
        ...
        public static implicit operator ulong?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new ulong?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="float"/>
        /// </summary>
        ...
        public static implicit operator float?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new float?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="double"/>
        /// </summary>
        ...
        public static implicit operator double?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new double?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="decimal"/>
        /// </summary>
        ...
        public static implicit operator decimal?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new decimal?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="DateTime"/>
        /// </summary>
        ...
        public static implicit operator DateTime?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new DateTime?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="DateTimeOffset"/>
        /// </summary>
        ...
        public static implicit operator DateTimeOffset?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new DateTimeOffset?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="TimeSpan"/>
        /// </summary>
        ...
        public static implicit operator TimeSpan?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new TimeSpan?(value);
        }
        /// <summary>
        /// 定义将 <see cref="IValue"/> 对象转换为 <see cref="Guid"/>
        /// </summary>
        ...
        public static implicit operator Guid?(IValue value)
        {
            return value == null ? null : value._value == null ? null : new Guid?(value);
        }
        #endregion
    }
}
