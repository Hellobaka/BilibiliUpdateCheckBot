...
using me.cqp.luohuaming.BilibiliUpdateChecker.Core;
using me.cqp.luohuaming.BilibiliUpdateChecker.Core.Domain;
...
namespace me.cqp.luohuaming.BilibiliUpdateChecker.App.Export
{
	/// <summary>	
	/// 表示酷Q事件导出的类	
	/// </summary>	
	...
	{	
		...
		{	
			return "9,me.cqp.luohuaming.BilibiliUpdateChecker";	
		}	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("me.cqp.luohuaming.BilibiliUpdateChecker", 1, 9, "哔哩哔哩更新监测", "1.5.0", 1, "落花茗", "监测动态、直播", authCode);	
			...
			AppData.UnityContainer.RegisterInstance<CQLog> ("me.cqp.luohuaming.BilibiliUpdateChecker", AppData.CQLog);	
